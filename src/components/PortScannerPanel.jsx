            ...
            <table className="w-full">
              ...
              <tbody>
                {localVulnerabilities.map((v, i) => (
                  <tr
                    key={i}
                    className={i % 2 === 0 ? "bg-white/5" : "bg-white/3"}
                  >
                    <td className="p-3 border-t border-white/10 font-mono">
                      <a
                    ...
                    <td className="p-3 border-t border-white/10 max-w-md text-sm">
                      {v.description}
                    </td>
                    <td className="p-3 border-t border-white/10">
                      {v.service ? (
